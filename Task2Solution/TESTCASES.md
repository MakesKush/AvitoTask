...
status = "error", result пустой объект либо информация об ошибке валидации.
...
Ожидаемый результат: 400 Bad Request (лайков должно быть > 0).
...
в теле: поля contacts, likes, viewCount.
...
Ожидаемый результат: 200 OK, корректная статистика (зависит от требований).
...
Предусловие: создать несколько объявлений и сохранить их ID.
